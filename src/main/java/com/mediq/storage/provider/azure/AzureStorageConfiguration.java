...
@ConditionalOnProperty(prefix = "storage", name = "provider", havingValue = "azure")
public class AzureStorageConfiguration {
    ...
    public BlobServiceClient blobServiceClient(StorageProperties properties) {
        ...
        if (StringUtils.hasText(azure.getConnectionString())) {
            ...
            builder.endpoint(endpoint)
                    .credential(new StorageSharedKeyCredential(azure.getAccountName(), azure.getAccountKey()));
        }
    ...
    @Bean
    public StorageProvider azureStorageProvider(BlobContainerClient containerClient) {
